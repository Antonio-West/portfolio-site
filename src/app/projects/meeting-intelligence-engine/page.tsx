      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 py-12">
        <div className="flex items-center justify-between gap-4 mb-8">
          ...
          <span className="text-xs font-mono text-emerald-400 bg-emerald-500/10 px-3 py-1 rounded border border-emerald-500/20">
            Commercial Production Contract &bull; Alive Industries
          </span>
        </div>
        ...
        <section className="space-y-6 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gray-900/90 border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="text-base font-bold text-white mb-2">Whereby Webhook &amp; Recording Processing</h3>
            ...
            <div className="bg-gray-900/90 border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="text-base font-bold text-white mb-2">Multi-Provider Summarisation Layer</h3>
              <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="bg-gray-900/90 border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="text-base font-bold text-white mb-2">Background Polling &amp; In-Memory Caching</h3>
              <p className="text-sm text-gray-300 leading-relaxed">
            ...
            <div className="bg-gray-900/90 border border-gray-800 rounded-xl p-6">
              ...
              <h3 className="text-base font-bold text-white mb-2">Drizzle ORM + Meeting Dashboard</h3>
              <p className="text-sm text-gray-300 leading-relaxed">
